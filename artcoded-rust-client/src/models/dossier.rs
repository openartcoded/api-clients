...
pub struct Dossier {
    ...
    #[serde(rename = "recalledForModification", skip_serializing_if = "Option::is_none")]
    pub recalled_for_modification: Option<bool>,
    #[serde(rename = "recalledForModificationDate", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "totalAdvancePayments", skip_serializing_if = "Option::is_none")]
