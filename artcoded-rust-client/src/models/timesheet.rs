...
pub struct Timesheet {
    ...
    #[serde(rename = "numberOfWorkingHours", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "numberOfWorkingDays", skip_serializing_if = "Option::is_none")]
    pub number_of_working_days: Option<i64>,
    #[serde(rename = "numberOfHoursWorked", skip_serializing_if = "Option::is_none")]
    pub number_of_hours_worked: Option<String>,
    #[serde(rename = "numberOfMinutesWorked", skip_serializing_if = "Option::is_none")]
