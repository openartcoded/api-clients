...
pub async fn file_to_lang(configuration: &configuration::Configuration, model_file: std::path::PathBuf, shacl_file: std::path::PathBuf) -> Result<String, Error<FileToLangError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_model_file = model_file;
    let p_form_shacl_file = shacl_file;

    let uri_str = format!("{}/api/toolbox/public/rdf/shacl-validation", configuration.base_path);
...
pub async fn file_to_lang1(configuration: &configuration::Configuration, lang: &str, file: std::path::PathBuf) -> Result<reqwest::Response, Error<FileToLang1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_lang = lang;
    let p_form_file = file;

    let uri_str = format!("{}/api/toolbox/public/rdf/file-to-lang", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_allowed_extensions(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<GetAllowedExtensionsError>> {

    let uri_str = format!("{}/api/toolbox/public/rdf/allowed-extensions", configuration.base_path);
...
pub async fn get_allowed_languages(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<GetAllowedLanguagesError>> {

    let uri_str = format!("{}/api/toolbox/public/rdf/allowed-languages", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn model_conversion1(configuration: &configuration::Configuration, model: &str, lang_of_model: &str, lang: &str) -> Result<String, Error<ModelConversion1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_model = model;
    let p_query_lang_of_model = lang_of_model;
    let p_query_lang = lang;

    let uri_str = format!("{}/api/toolbox/public/rdf/model-to-lang", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
