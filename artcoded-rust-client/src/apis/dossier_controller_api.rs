...
pub async fn active_dossier(configuration: &configuration::Configuration, ) -> Result<models::Dossier, Error<ActiveDossierError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Dossier`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Dossier`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn add_document_to_dossier(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<AddDocumentToDossierError>> {
...
pub async fn bookmarked(configuration: &configuration::Configuration, arg0: models::Pageable) -> Result<models::PagedModelDossier, Error<BookmarkedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PagedModelDossier`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PagedModelDossier`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn close_active_dossier(configuration: &configuration::Configuration, ) -> Result<models::Dossier, Error<CloseActiveDossierError>> {

    let uri_str = format!("{}/api/dossier/close-active-dossier", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn delete3(configuration: &configuration::Configuration, ) -> Result<models::Restore200Response, Error<Delete3Error>> {
...
pub async fn find_all8(configuration: &configuration::Configuration, closed: Option<bool>) -> Result<Vec<models::Dossier>, Error<FindAll8Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::Dossier&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::Dossier&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_all_paged(configuration: &configuration::Configuration, arg1: models::Pageable, closed: Option<bool>) -> Result<models::PagedModelDossier, Error<FindAllPagedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn find_by_fee_id(configuration: &configuration::Configuration, id: &str) -> Result<models::Dossier, Error<FindByFeeIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn find_by_id3(configuration: &configuration::Configuration, id: &str) -> Result<models::Dossier, Error<FindById3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn generate_summary(configuration: &configuration::Configuration, id: &str) -> Result<reqwest::Response, Error<GenerateSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn get_dossier_total_size(configuration: &configuration::Configuration, id: &str) -> Result<i64, Error<GetDossierTotalSizeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn get_import_dossier_xlsx_example(configuration: &configuration::Configuration, ) -> Result<reqwest::Response, Error<GetImportDossierXlsxExampleError>> {
...
pub async fn get_summaries(configuration: &configuration::Configuration, id: Vec<String>) -> Result<Vec<models::DossierSummary>, Error<GetSummariesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::DossierSummary&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::DossierSummary&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_summaries1(configuration: &configuration::Configuration, closed: Option<bool>) -> Result<Vec<models::DossierSummary>, Error<GetSummaries1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_closed = closed;
...
pub async fn get_summary(configuration: &configuration::Configuration, id: &str) -> Result<models::DossierSummary, Error<GetSummaryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DossierSummary`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DossierSummary`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn import_dossier_from_zip(configuration: &configuration::Configuration, zip: std::path::PathBuf) -> Result<(), Error<ImportDossierFromZipError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_form_zip = zip;
...
pub async fn new_dossier(configuration: &configuration::Configuration, dossier: models::Dossier) -> Result<models::Dossier, Error<NewDossierError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn new_from_previous(configuration: &configuration::Configuration, ) -> Result<models::Dossier, Error<NewFromPreviousError>> {
...
pub async fn process_fees_for_dossier(configuration: &configuration::Configuration, request_body: Vec<String>) -> Result<(), Error<ProcessFeesForDossierError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn process_invoice_for_dossier(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ProcessInvoiceForDossierError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn recall_for_modification(configuration: &configuration::Configuration, dossier: models::Dossier) -> Result<models::Dossier, Error<RecallForModificationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_dossier = dossier;

    let uri_str = format!("{}/api/dossier/recall-for-modification", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn remove_document(configuration: &configuration::Configuration, id: &str) -> Result<models::Dossier, Error<RemoveDocumentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn remove_fee(configuration: &configuration::Configuration, fee_id: &str) -> Result<models::Dossier, Error<RemoveFeeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn remove_invoice(configuration: &configuration::Configuration, id: &str) -> Result<models::Dossier, Error<RemoveInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn toggle_bookmarked3(configuration: &configuration::Configuration, id: &str) -> Result<models::Dossier, Error<ToggleBookmarked3Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn update_active_dossier(configuration: &configuration::Configuration, dossier: models::Dossier) -> Result<models::Dossier, Error<UpdateActiveDossierError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_dossier = dossier;
