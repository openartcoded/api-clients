...
pub async fn delete11(
    ...
    id: &str,
) -> Result<models::Restore200Response, Error<Delete11Error>> {
...
pub async fn find_all6(
    configuration: &configuration::Configuration,
    arg1: models::Pageable,
    fee_search_criteria: models::FeeSearchCriteria,
) -> Result<models::PagedModelFee, Error<FindAll6Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PagedModelFee`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PagedModelFee`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_all7(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Fee>, Error<FindAll7Error>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::Fee&gt;`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::Fee&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_by_id2(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Fee, Error<FindById2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Fee`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Fee`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_by_ids2(
    configuration: &configuration::Configuration,
    id: Vec<String>,
) -> Result<Vec<models::Fee>, Error<FindByIds2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
) -> Result<models::Fee, Error<ManualSubmitError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn remove_attachment(
    ...
    id: &str,
    attachment_id: &str,
) -> Result<models::Fee, Error<RemoveAttachmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn summaries(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::FeeSummary>, Error<SummariesError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::FeeSummary&gt;`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::FeeSummary&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn toggle_bookmarked2(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Fee, Error<ToggleBookmarked2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn update_price(
    ...
    price_h_vat: f64,
    vat: f64,
) -> Result<models::Fee, Error<UpdatePriceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn update_tag1(
    configuration: &configuration::Configuration,
    tag: &str,
    request_body: Vec<String>,
) -> Result<Vec<models::Fee>, Error<UpdateTag1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tag = tag;
