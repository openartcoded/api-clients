...
pub async fn delete5(configuration: &configuration::Configuration, id: &str) -> Result<models::Restore200Response, Error<Delete5Error>> {
...
pub async fn delete_all(configuration: &configuration::Configuration, ) -> Result<models::Restore200Response, Error<DeleteAllError>> {
...
pub async fn download2(configuration: &configuration::Configuration, id: &str) -> Result<reqwest::Response, Error<Download2Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn find_all1(configuration: &configuration::Configuration, arg1: models::Pageable, file_upload_search_criteria: models::FileUploadSearchCriteria) -> Result<models::PagedModelFileUpload, Error<FindAll1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PagedModelFileUpload`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PagedModelFileUpload`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_by_correlation_id(configuration: &configuration::Configuration, correlation_id: &str) -> Result<Vec<models::FileUpload>, Error<FindByCorrelationIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_correlation_id = correlation_id;

    let uri_str = format!("{}/api/resource/find-by-correlation-id", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn find_by_correlation_id_public(configuration: &configuration::Configuration, correlation_id: &str) -> Result<Vec<models::FileUpload>, Error<FindByCorrelationIdPublicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_correlation_id = correlation_id;

    let uri_str = format!("{}/api/resource/public/find-by-correlation-id", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn find_by_id6(configuration: &configuration::Configuration, id: &str) -> Result<models::FileUpload, Error<FindById6Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::FileUpload`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::FileUpload`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn find_by_id_public(configuration: &configuration::Configuration, id: &str) -> Result<models::FileUpload, Error<FindByIdPublicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn find_by_ids4(configuration: &configuration::Configuration, id: Vec<String>) -> Result<Vec<models::FileUpload>, Error<FindByIds4Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn get_correlation_links(configuration: &configuration::Configuration, ) -> Result<std::collections::HashMap<String, String>, Error<GetCorrelationLinksError>> {
...
pub async fn public_download(configuration: &configuration::Configuration, id: &str) -> Result<reqwest::Response, Error<PublicDownloadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/api/resource/public/download/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn toggle_bookmarked(configuration: &configuration::Configuration, id: &str) -> Result<models::FileUpload, Error<ToggleBookmarkedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_id = id;
...
pub async fn upload(configuration: &configuration::Configuration, file: std::path::PathBuf, correlation_id: Option<&str>, public_resource: Option<bool>) -> Result<models::FileUpload, Error<UploadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
